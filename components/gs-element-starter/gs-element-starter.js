...
Polymer({
  ...
  sayHello: function sayHello(greeting) {
    ...
    return 'gs-element-starter says, ' + response;
  },

  /**
   * The `gs-element-starter-lasers` event is fired whenever `fireLasers` is called.
   *
   * @event gs-element-starter-lasers
   * @detail {{sound: String}}
   */
  ...
  fireLasers: function fireLasers() {
    this.fire('gs-element-starter-lasers', { sound: 'Pew pew!' });
  }
});